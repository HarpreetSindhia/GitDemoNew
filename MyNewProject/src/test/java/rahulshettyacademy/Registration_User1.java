...
public class Registration_User1 {
	public static void main(String[] args) {
		...
		driver.findElement(By.cssSelector("#firstName")).sendKeys("Harpreet");
		...
		driver.findElement(By.cssSelector("#userMobile")).sendKeys("9876486934");
		...
		driver.findElement(By.cssSelector("#confirmPassword")).sendKeys("harry@Code5");
