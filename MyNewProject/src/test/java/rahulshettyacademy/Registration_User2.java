...
public class Registration_User2 {
	public static void main(String[] args) {
		...
		System.out.println("Remote Repository updated ");
		
		System.out.println("Remote Repository updated till done");
		
		System.out.println("Updations made by Harpreet Sindhia");
